# vuezx-cli [![Build Status](https://img.shields.io/circleci/project/vuejs/vue-cli/master.svg)](https://circleci.com/gh/vuejs/vue-cli) [![npm package](https://img.shields.io/npm/v/vue-cli.svg)](https://www.npmjs.com/package/vue-cli)
...
``` bash
$ npm install -g vuezx-cli
```

### Usage

``` bash
$ vuezx init <template-name> <project-name>
```

Example:

``` bash
$ vuezx init webpack my-project
```
...
Use vuezx-cli as a zero-configuration development tool for your Vue apps and component, check out the [docs](/docs/build.md).
...
- [webpackzx](https://github.com/vuejs-templates/pwa) - 基于iview组件的，有固定header的单页面应用模板

- [webpackzx-sider](https://github.com/vuejs-templates/simple) - 基于iview组件的，有固定header和sider的单页面应用模板

- [webpackzx-tabs](https://github.com/vuejs-templates/simple) - 基于iview组件的，有固定header/sider/tabs的单页面应用模板

- [webpackzx-multiple](https://github.com/vuejs-templates/simple) - 基于iview组件的，有固定header和sider的多页面应用模板
...
``` bash
vuezx init ~/fs/path/to-custom-template my-project
```
...
`vuezx-cli` uses [metalsmith](https://github.com/segmentio/metalsmith) to generate the project.
...
`vuezx-cli` uses the tool [`download-git-repo`](https://github.com/flipxfx/download-git-repo) to download the official templates used. The `download-git-repo` tool allows you to indicate a specific branch for a given repository by providing the desired branch name after a pound sign (`#`).

The format needed for a specific official template is:

```
vuezx init '<template-name>#<branch-name>' <project-name>
```
...
```
vuezx init 'webpack-simple#1.0' mynewproject
```
